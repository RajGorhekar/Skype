...
import 'package:skype/configs/agoraConfigs.dart';
final String App_Id = '78da691a55004f26b32a74bc095ae20f';
...
class _CallScreenState extends State<CallScreen> {
  ...
  Future<void> initializeAgora() async {
    var APP_ID='78da691a55004f26b32a74bc095ae20f';
        if (APP_ID.isEmpty) {
      setState(() {
        _infoStrings.add(
  ...
  Future<void> _initAgoraRtcEngine() async {
    String APP_ID = '78da691a55004f26b32a74bc095ae20f';
